        ...
        >
            ...
            >
                <g id="Warlock">
                    ...
                    <path
                        fill="#FFFFFF"
                        d="M62.16,73.93,54.82,55.48l.31-.19,3.19-1.68c.4-.2.61-.11.69.34.14.82.26,1.64.39,2.45.17,1.05.35,2.1.52,3.16l.48,3c.17,1,.35,2.08.52,3.11l.39,2.5.51,3.06c.13.82.27,1.63.4,2.45a1.48,1.48,0,0,1,0,.21Z"
                    />
                    <path
                        fill="#FFFFFF"
                        d="M37.78,73.91c.07-.5.14-1,.22-1.49.17-1.06.35-2.11.52-3.16s.32-2,.49-3l.51-3.15c.17-1,.35-2,.52-3.07l.48-3c.16-1,.31-2,.48-3,.09-.49.28-.58.71-.35l3.5,1.83L37.86,73.93Z"
                    />
                    <path
                        fill="#FFFFFF"
                        d="M61.79,49.36l2,1.59L67,53.43a1.06,1.06,0,0,1,.33.46Q69,58.35,70.58,62.8a1.54,1.54,0,0,1,0,.19c-.27-.3-.5-.54-.72-.8-1.13-1.3-2.25-2.61-3.38-3.92L63.8,55.2c-1-1.14-2-2.29-3-3.42a.39.39,0,0,1-.07-.48c.19-.41.32-.85.52-1.25A4.79,4.79,0,0,1,61.79,49.36Z"
                    />
                    <path
                        fill="#FFFFFF"
                        d="M29.4,62.91c.39-1.08.78-2.16,1.18-3.24.66-1.84,1.36-3.68,2-5.54a2.06,2.06,0,0,1,.8-1l4.56-3.57c.09-.07.18-.11.26-.17.54.31.6.92.89,1.38.39.64.12,1.05-.31,1.52-1,1.09-1.95,2.23-2.93,3.35-.71.82-1.44,1.63-2.16,2.45L31.5,60.62c-.49.57-1,1.13-1.49,1.7l-.54.62Z"
                    />
                    <path
                        fill="#FFFFFF"
                        d="M42.25,29c-.63-.13-1.26-.24-1.89-.38-1.11-.25-2.21-.53-3.32-.78a.52.52,0,0,1-.44-.34c-.75-2.24-1.5-4.48-2.2-6.77l7.92,8.12Z"
                    />
                    <path
                        fill="#FFFFFF"
                        d="M65.68,20.72,64.6,23.9c-.38,1.13-.77,2.26-1.13,3.4a.66.66,0,0,1-.55.5c-1.48.32-2.94.69-4.41,1a1.91,1.91,0,0,1-.82,0l7.93-8.13Z"
                    />
                </g>
            </g>
        </svg>
